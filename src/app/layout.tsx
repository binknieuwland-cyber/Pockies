            ...
            <div className="max-w-app mx-auto px-4 lg:px-8 pt-3 lg:pt-4 pb-0">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div className="ml-auto flex items-center gap-3 shrink-0">
                  <p className="hidden lg:block font-mono text-xs text-ink-300">Sinds 1962</p>
                  <form action={logoutAction}>
                    <button
                      type="submit"
                      className="font-mono text-[11px] uppercase tracking-wider text-ink-300 hover:text-white border border-ink-600 hover:border-ink-400 rounded-sm px-2.5 py-1.5 transition-colors"
                    >
                      Uitloggen
                    </button>
                  </form>
